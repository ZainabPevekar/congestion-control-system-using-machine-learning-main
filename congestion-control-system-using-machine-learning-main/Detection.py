    ...
    def __init__(self, top=None):
        ...
        def sendChalan(event):
            ...
            try:
                ...
                message = "Hi, User<br><br>You have broken the following traffic rules "+challanBreaked+"<br><br>Please proceed to pay online through UPI or by paying in cash to the nearest police <b>"+str(amount)+"Rs.</b> as Challan."
                data = open(self.listFiles[self.ChallanImg]).read().split('\n')
                self.yag.send(to='anasmukri1004@gmail.com', subject="Traffic Rule Challan", contents=message, attachments=data[0])
                self.yag.close()
